...
// string Ex = 7;
// }
// GoIM_sdk.FriendInfo(FriendUser) != imdb.Friend(FriendUserID)
type Friend struct {
...
// string Ex = 9;
// }
// GoIM_sdk.FriendRequest(nickname, farce url ...) != imdb.FriendRequest
...
//	}
//
//	GoIM_sdk.GroupInfo (OwnerUserID ,  MemberCount )> imdb.Group
type Group struct {
...
// }  GoIM_sdk.GroupMemberFullInfo(AppMangerLevel) > imdb.GroupMember
...
// int64 HandleTime = 8;
// string Ex = 9;
// }GoIM_sdk.GroupRequest == imdb.GroupRequest
...
// string Ex = 7;
// }
// GoIM_sdk.BlackInfo(BlackUserInfo) != imdb.Black (BlockUserID)
type Black struct {
	OwnerUserID    string    `gorm:"column:owner_user_id;primary_key;size:64"`
